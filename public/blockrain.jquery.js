...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      // Copy
      playText: 'Espera ai que já vão da play',
      playButtonText: 'Play',
    ...
    _SetupBoard: function() {
      ...
      this._board = {
        ...
        drawBlock: function(x, y, blockType, blockVariation, blockIndex, blockRotation, falling) {
          ...
          let toClient = {x, y, blockType, blockVariation, blockIndex, blockRotation, falling}

          game.options.onRender2.call(game.element, toClient);
